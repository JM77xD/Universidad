...
/**
  ...
  *
  * @author Jose María Ramírez González
  * @date Octubre 2017
  */
...
/**
  ...
  * @param r racional a restar con el objeto implicito
  */
  Racional operator-(Racional r);

/**
 * @brief Divide dos racionales
 * @param r Racional por el que dividir el objeto implícito
 */
  Racional operator/(Racional r);
...
/**
 * @brief Devuelve el valor real asociado al racional implícito
 * @param r Racional que queremos sacar su valor real
 * @return Devuelve un double con el valor real del racional
 */
  double valorReal(Racional r);

/**
 * @brief Convierte un racional en irreducible
 * @param r Racional que se desea convertir en irreducible
 * @return Devuelve el un racional con el mismo valor que el pasado por parámetros, pero en formato irreducible
 */
