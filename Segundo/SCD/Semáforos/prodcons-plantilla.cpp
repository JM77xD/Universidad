...
Semaphore available_read(0),              //semáforo para el proceso de lectura
          available_write(1),             //semáforo para el proceso de escritura
          candado(0);
...
void  funcion_hebra_productora(  )
{
   for( unsigned i = 0 ; i < num_items ; i++ )
   {
      sem_wait(available_write);
      int dato = producir_dato();
      vector_intermedio[i] = dato;
      sem_signal(available_read);
      sem_signal(candado);
   }
}
...
void funcion_hebra_consumidora(  )
{
   ...
   {
      int dato ;
      sem_wait(available_read);
      dato = vector_intermedio[i];
      sem_wait(candado);
      consumir_dato( dato );
      sem_signal(available_write);
    }
}
//----------------------------------------------------------------------
